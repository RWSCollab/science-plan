...
-   Each original draft chapter was then revised considering the detailed comments submitted.
...
-   The four caucuses co-wrote an Executive Summary that summarizes research recommendations the Subcommittees and presents a framework for collaboration to implement the Science Plan.
...
The new Executive Summary of the Science Plan lays out actions that the four sectors will take to implement the Science Plan.
...
For funds provided to RWSC, funding decisions will reside with the Steering Committee, informed by the expert Subcommittees, considering any limitations on the use of funds, and funders' priorities.
